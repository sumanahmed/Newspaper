            ...
            <div class="well" style="">
                ...
                <form action="{{ url('/update-pages') }}" method="POST" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="about_page_sub_title" class="form-control" id="pageSubTitle"
                                   value="{{ $pagesContent->about_page_sub_title }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" name="about_page_content" rows="10" style="resize: none"
                                      id="contentDescription">{{ $pagesContent->about_page_content }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" name="address" rows="10" style="resize: none"
                                      id="categoryDescription">{{ $pagesContent->address }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="mobile_no" class="form-control" id="mobile_no"
                                   value="{{ $pagesContent->mobile_no }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="gmap" class="col-sm-3 control-label">Map Link</label>
                        <div class="col-sm-9">
                            <input type="text" name="gmap" class="form-control" id="gmap"
                                   value="{{ $pagesContent->gmap }}">
                        </div>
                    </div>
                    <div class="form-group">
